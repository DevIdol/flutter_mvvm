...
import '../user_upsert/user_upsert_page.dart';
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => UserUpsertPage(user: updateUser.value),
                ),
              );
            },
          ),
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildDetailRow(context, 'First Name:', userData.firstName),
            _buildDetailRow(context, 'Last Name:', userData.lastName),
            ...
            _buildDetailRow(
                context, 'CreatedAt:', userData.createdAt.convertYMD()),
          ],
        ),
      ),
    );
